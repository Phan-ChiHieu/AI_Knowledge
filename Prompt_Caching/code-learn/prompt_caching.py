...
# model_name_emb = "Alibaba-NLP/gte-multilingual-base" # tốt cho tiếng Việt
embedder = SentenceTransformer(
    model_name_emb, token=os.getenv("HF_API_KEY"), trust_remote_code=True
)
...
def store_response(
    query: str, result: str, extra_info: Optional[Dict[str, Any]] = None
) -> None:
